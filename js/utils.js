...
//					success && success(pos);
//					if (results[1]) {
//						var currentaddr = results[1].formatted_address
//						plus.storage.setItem('currentaddr', currentaddr);
//						console.log(plus.storage.getItem('currentaddr'))
//						success && success();
//					} else {
//						success && success();
...
//				}
//			});
			plus.storage.setItem('currentaddr', '中国重庆市南岸区');
			console.log(plus.storage.getItem('currentaddr'))
			success && success();
		}, function(e) {
			success && success();
